...
function del(){
    let tbody = document.querySelector('#csv_data_table tbody');
    tbody.innerHTML = "";
    var data_02 = data.filter(function(data){
        return data.場所 == "403";
    })
    console.log(data_02);
    //　CSVの内容を表示
    ...
    tbody.innerHTML = tbody_html;
    console.log(tbody_html);
    message.innerHTML = "403号室には" + data_02.length + "件のデータがあります。"
};
...
function del2(){
    ...
    tbody.innerHTML = tbody_html;
    console.log(tbody_html);
    message.innerHTML = "User : uchidaは" + data_02.length + "件のデータを持っています。"
};